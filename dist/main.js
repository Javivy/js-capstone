...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"fetchData\": () => (/* binding */ fetchData),\n/* harmony export */   \"fetchPokemons\": () => (/* binding */ fetchPokemons)\n/* harmony export */ });\n/* harmony import */ var _displayPokemon_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./displayPokemon.js */ \"./src/modules/displayPokemon.js\");\n\n\nconst fetchData = async (id) => {\n  const url = `https://pokeapi.co/api/v2/pokemon/${id}`;\n  let fetchedData;\n  await fetch(url)\n    .then((res) => res.json())\n    .then((data) => {\n      (0,_displayPokemon_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(data);\n      fetchedData = data;\n    });\n  return fetchedData;\n};\n\nconst fetchPokemons = (number) => {\n  for (let i = 1; i <= number; i += 1) {\n    fetchData(i);\n  }\n};\n\n\n\n\n//# sourceURL=webpack://js-capstone/./src/modules/fetchData.js?");
...
eval("module.exports = __webpack_require__.p + \"52513bd82ec51c6a3adb.png\";\n\n//# sourceURL=webpack://js-capstone/./src/assets/images/heart-icon.png?");
